 ...
 *******************************************************************************/
package userGeneratedContent.scenarioExtractorScripts;
...
import staticContent.evaluation.traceParser.interfaces.Extractor;
import staticContent.evaluation.traceParser.interfaces.FlowFilter;
import staticContent.evaluation.traceParser.statistics.HostSampleSource.UrnModel;
import userGeneratedContent.scenarioExtractorScripts.flowFilter.HttpWhitelist;

public class Example_Extractor extends Extractor {
	...
	public Example_Extractor(String pathToTraceFolder, int users, int lengthInMs, String outputFileName) {
	...
	private static String setParameters(String pathToTraceFolder, int users, int lengthInMs, String outputFileName) {
		Example_Extractor.outputFileName = outputFileName;
		Example_Extractor.users = users;
		Example_Extractor.lengthInMs = lengthInMs;
	...
	public static void main(String[] args) {
		new Example_Extractor("./inputOutput/global/traces/auck8/", 1000, 120*60*1000,"auck8_120min_1000user_dpe");
		new Example_Extractor("./inputOutput/global/traces/auck8/", 10000, 10*60*1000,"auck8_10min_10000user_dpe");
		}
