...
import staticContent.evaluation.loadGenerator.LoadGenerator.MPL_Mode;
import staticContent.evaluation.loadGenerator.mixPacketLevelTraffic.MPL_ClientWrapper;
import staticContent.evaluation.loadGenerator.mixPacketLevelTraffic.MPL_FS_ConstantRate;
import staticContent.evaluation.loadGenerator.mixPacketLevelTraffic.MPL_FS_Poisson;
...
public class MPL_FixedScheduleLoadGenerator extends FixedScheduleLoadGenerator {
	...
	public MPL_FixedScheduleLoadGenerator(LoadGenerator owner) {
		...
		if (useYieldWaitScheduler)
			this.scheduler = new InOrderYieldWaitScheduler<MPL_ClientWrapper>(settings);
		else
			this.scheduler = new ThreadPoolScheduler<MPL_ClientWrapper>(settings);
