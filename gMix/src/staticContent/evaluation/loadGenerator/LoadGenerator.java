...
import staticContent.evaluation.loadGenerator.applicationLevelTraffic.requestReply.ALRR_Scheduled_ExitNodeRequestReceiver;
import staticContent.evaluation.loadGenerator.asFastAsPossible.AFAP_Echo_ExitNodeRequestReceiver;
import staticContent.evaluation.loadGenerator.asFastAsPossible.AFAP_LoadGenerator;
import staticContent.evaluation.loadGenerator.dynamicSchedule.ALM_DS_Tracefile;
import staticContent.evaluation.loadGenerator.dynamicSchedule.DynamicScheduleLoadGenerator;
import staticContent.evaluation.loadGenerator.fixedSchedule.FixedScheduleLoadGenerator;
import staticContent.evaluation.loadGenerator.traceBasedTraffic.RaFM_ExitNodeRequestReceiver;
import staticContent.evaluation.loadGenerator.traceBasedTraffic.RaFM_LoadGenerator;
...
public class LoadGenerator extends GMixTool {
	...
	public LoadGenerator(CommandLineParameters commandLineParameters) {
		...
		if (commandLineParameters.gMixTool == ToolName.LOADGEN_DEMO)
