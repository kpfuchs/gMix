...
public class SimpleGlobalModelnetFactoryV1 {
	public static GlobalExecutionPlan createGlobalPlan() {
		GlobalExecutionPlan globalPlan = new SimpleExecutionPlan(null);		
		return globalPlan;
	}
}
