...
public class LocalTestNormal extends GMixTool implements EipEventListener {
	...
	public LocalTestNormal(CommandLineParameters params) {
		this.params = params;
	...
	public void startClient() {
		...
		CommandLineParameters parameters = new CommandLineParameters(new String[0], ToolName.CLIENT,params.configFile);
