...
public class SourceRoutingClientController extends RoutingController implements SourceRoutingClient {

	 
	public SourceRoutingClientController(
			AnonNode anonNode, 
			Settings settings, 
	...
	public MixList choseRoute() {
		return ((SourceRoutingClient)implementation).choseRoute();
	}


	@Override
	public MixList choseRoute(int destPseudonym) {
		return ((SourceRoutingClient)implementation).choseRoute(destPseudonym);
	}
