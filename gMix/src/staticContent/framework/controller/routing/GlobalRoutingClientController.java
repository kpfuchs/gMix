...
public class GlobalRoutingClientController extends RoutingController implements GlobalRoutingClient {

	
	public GlobalRoutingClientController(
			AnonNode anonNode, 
			Settings settings, 
	...
	public MixList choseRoute() {
		return ((GlobalRoutingClient)implementation).choseRoute();
	}


	@Override
	public MixList choseRoute(int destPseudonym) {
		return ((GlobalRoutingClient)implementation).choseRoute(destPseudonym);
	}
