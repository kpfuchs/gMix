...
public abstract class NetworkNode implements EventExecutor, Identifiable {
	...
	public NetworkNode(String identifier, Simulator simulator, DelayBox delayBox) {
	...
	// TODO: muss auch mehrere connections zurückgeben können
	/**
	 ...
	 */
	public void setDelayBox(DelayBox delayBox) {
		this.delayBox = delayBox;
	}
