...
public class Poisson extends RandomVariable {
	...
	public Poisson(String[] parameters) {
		...
		try {
			...
			// test:
			this.randomDataImpl.nextPoisson(mean);
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException(errorMessage); 
		}
	...
	public int drawIntSample() {
		return (int) randomDataImpl.nextPoisson(mean);
	}
