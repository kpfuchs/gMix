...
public class InfoServiceClient_v1 {
	...
	public static void main(String[] args) { // TODO
		InfoServiceClient_v1 is = null;
		try {is = new InfoServiceClient_v1(InetAddress.getByName("localhost"), 22002);} catch (UnknownHostException e) {e.printStackTrace();}
	...
	public InfoServiceClient_v1(InetAddress infoServiceAddress, int infoServicePort) {
	...
	public synchronized int registerAsMix() {
		connect();
		try {
			return InfoServiceServer_v1.client_REGISTER_AS_MIX(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized int registerAsClient() {
		connect();
		try {
			return InfoServiceServer_v1.client_REGISTER_AS_CLIENT(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized int getNumberOfMixes() {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_NUMBER_OF_MIXES(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized MixList getMixList() {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_MIX_LIST(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
			return getMixList();
		}
	...
	public synchronized byte[] getValueFromMix(int mixId, String key) {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_VALUE_FROM_MIX(outputStream, inputStream, mixId, key);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized byte[] getValue(String key) {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_VALUE(outputStream, inputStream, key);
		} catch (Exception e) {
			e.printStackTrace();
			return getValue(key);
		}
	...
	public synchronized byte[] getValueFromClient(int clientId, String key) {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_VALUE_FROM_CLIENT(outputStream, inputStream, clientId, key);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized byte[][] getValueFromAllMixes(String key) {
		connect();
		try {
			return InfoServiceServer_v1.client_GET_VALUE_FROM_ALL_MIXES(outputStream, inputStream, key);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void postValueAsMix(int mixId, String key, byte[] value) {
		connect();
		try {
			InfoServiceServer_v1.client_POST_VALUE_AS_MIX(outputStream, inputStream, mixId, key, value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void postValue(String key, byte[] value) {
		connect();
		try {
			InfoServiceServer_v1.client_POST_VALUE(outputStream, inputStream, key, value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void postValueAsClient(int clientid, String key, byte[] value) {
		connect();
		try {
			InfoServiceServer_v1.client_POST_VALUE_AS_CLIENT(outputStream, inputStream, clientid, key, value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized int getSuggestedPort() {
		connect();
		try {
			return InfoServiceServer_v1.client_SUGGEST_MIX_PORT(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized boolean getIsDebugModeOn() {
		connect();
		try {
			return InfoServiceServer_v1.client_is_DEBUG_MODE_ON(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized boolean getIsDuplexModeOn() {
		connect();
		try {
			return InfoServiceServer_v1.client_is_DUPLEX_ON(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized boolean getIsLocalModeOn() {
		connect();
		try {
			return InfoServiceServer_v1.client_is_LOCAL_MODE_ON(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void waitForEndOfRegistrationPhase() {
		connect();
		try {
			InfoServiceServer_v1.client_WAIT_FOR_END_OF_REGISTRATION_PHASE(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void waitForEndOfInitializationPhase() {
		connect();
		try {
			InfoServiceServer_v1.client_WAIT_FOR_END_OF_INITIALIZATION_PHASE(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void waitForEndOfBeginPhase() {
		connect();
		try {
			InfoServiceServer_v1.client_WAIT_FOR_END_OF_BEGIN_PHASE(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public synchronized void waitTillCascadeIsUp() {
		connect();
		try {
			InfoServiceServer_v1.client_WAIT_TILL_CASCADE_IS_UP(outputStream, inputStream);
		} catch (Exception e) {
			e.printStackTrace();
