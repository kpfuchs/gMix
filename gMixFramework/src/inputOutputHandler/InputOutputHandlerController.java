...
public class InputOutputHandlerController extends Controller implements InputOutputHandler {
	...
	private InputOutputHandler inputOutputHandlerImplementation;
	
	
	@Override
	public void instantiateSubclass() {
		this.inputOutputHandlerImplementation = LocalClassLoader.instantiateImplementation(this, InputOutputHandler.class, settings);
	}
