...
public class BinomialPool extends OutputStrategy {
	...
	protected BinomialPool(Mix mix, Simulator simulator) {
		...
		super(mix, simulator);
		int sendingRate = Settings.getPropertyAsInt("BINOMIAL_POOL_SENDING_RATE");
		double maxOutputFraction = Settings.getPropertyAsDouble("BINOMIAL_POOL_MAX_OUTPUT_FRACTION");
		double mean = Settings.getPropertyAsDouble("BINOMIAL_POOL_MEAN");
		double stdDev = Settings.getPropertyAsDouble("BINOMIAL_POOL_STANDARD_DEVIATION");
