...
public enum ChannelEstablishMessagePart {
	...
	/** 
	 * Key used to decrypt the symmetrically encrypted message part in Requests.
	 */
	SESSION_KEY_FOR_REQUEST_CHANNEL (  52,  67,  true),
	
	/** 
	 * Key used to symmetrically encrypt Replies.
	 */
	SESSION_KEY_FOR_REPLY_CHANNEL ( 68,  83,  true),
	
	/** Initialization vector for request cipher.*/
	SESSION_IV_FOR_REQUEST_CHANNEL ( 84,  99,  true),
	
	/** Initialization vector for reply cipher.*/
	SESSION_IV_FOR_REPLY_CHANNEL ( 100,  115,  true),
	
	/** Point of time, the message was created. */
	TIMESTAMP ( 116,  123,  true),

	/** 
	 * Reserved space (used to fill up header's size to a multiple of the block 
	 * size). Use random Data to fill it.
	 */
	RESERVED ( 124,  255,  true),
	 ...
	 * @see Payload
	 */
	PAYLOAD				( 256, 1103, false),
	
	/** The signed data of this message. */
	SIGNED_DATA			(  256, 1103, false),
	
	/** The asymmetrically encrypted part of the message. */
	ASYMMETRIC_PART_ENCRYPTED 	(   0,  255, false),
	
	/** The asymmetrically encrypted part of the message. */
	ASYMMETRIC_PART_PLAIN 	(   0,  189, false),
