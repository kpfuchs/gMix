...
public class Mix extends NetworkNode {
	...
	public Mix(String identifier, Simulator simulator, DelayBox delayBox, boolean isFirstMix, boolean isLastMix) {
		...
		PROCESSING_TIME_FOR_1000_REQUESTS = new Double(Settings.getProperty("PROCESSING_TIME_FOR_1000_REQUESTS")); // ms
		PROCESSING_TIME_FOR_1000_REPLIES = new Double(Settings.getProperty("PROCESSING_TIME_FOR_1000_REPLIES")); // ms
