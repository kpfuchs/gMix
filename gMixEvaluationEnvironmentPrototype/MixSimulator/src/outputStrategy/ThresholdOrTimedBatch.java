...
public class ThresholdOrTimedBatch extends OutputStrategy {
	...
	protected ThresholdOrTimedBatch(Mix mix, Simulator simulator) {
		...
		super(mix, simulator);
		int sendingRate = Settings.getPropertyAsInt("THRESHOLD_OR_TIMED_BATCH_SENDING_RATE");
		int batchSize = Settings.getPropertyAsInt("THRESHOLD_OR_TIMED_BATCH_BATCH_SIZE");
