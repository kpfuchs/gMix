...
public class TimedDynamicPool extends OutputStrategy {
	...
	protected TimedDynamicPool(Mix mix, Simulator simulator) {
		...
		super(mix, simulator);
		int sendingRate = Settings.getPropertyAsInt("TIMED_DYNAMIC_POOL_SENDING_RATE");
		int minMessages = Settings.getPropertyAsInt("TIMED_DYNAMIC_POOL_MIN_MESSAGES_IN_POOL");
		double fraction = Settings.getPropertyAsDouble("TIMED_DYNAMIC_POOL_FRACTION");
