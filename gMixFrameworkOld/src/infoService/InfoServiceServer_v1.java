...
public class InfoServiceServer_v1 {
	// TODO: ssl
	...
	public InfoServiceServer_v1() {
		Properties properties = new Properties();
		try {
			//System.out.println(InetAddress.getLocalHost().getHostAddress());
    		properties.load(new FileInputStream(Paths.IS_PROPERTY_FILE_PATH));
    		ProtocolPrimitives.DEBUG = properties.getProperty("DISPLAY_TRANSACTIONS").equalsIgnoreCase("TRUE");
    		this.LOCAL_MODE_ON = properties.getProperty("LOCAL_MODE_ON").equalsIgnoreCase("TRUE");
    		if (!LOCAL_MODE_ON)
    		...
    		this.DEBUG_MODE_ON = properties.getProperty("DEBUG_MODE_ON").equalsIgnoreCase("TRUE");
    		this.DUPLEX_ON = properties.getProperty("DUPLEX_ON").equalsIgnoreCase("TRUE");
    		this.NUMBER_OF_MIXES = new Integer(properties.getProperty("NUMBER_OF_MIXES"));
    		...
    		this.BACKLOG = new Integer(properties.getProperty("BACKLOG"));
		} catch(IOException e) {
			e.printStackTrace();
			throw new RuntimeException("property file " +Paths.IS_PROPERTY_FILE_PATH +" could not be loaded! it should be placed in the same directory as the gMixFramework.jar");
	    }
