 ...
 * @see NtpMessage
 */
public class NetworkClockController extends Controller implements NetworkClock {
	...
	private NetworkClock networkClockImplementation;
	...
	public void instantiateSubclass() {
		this.networkClockImplementation = LocalClassLoader.instantiateImplementation(this, NetworkClock.class, settings);
	}
