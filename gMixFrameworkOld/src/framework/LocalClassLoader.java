...
public class LocalClassLoader extends ClassLoader {
	...
	public static <T> T newInstance(String packageName, String className) throws ClassNotFoundException, InstantiationException, IllegalAccessException { 
		...
		assert !(instance instanceof SubImplementation) :"SubImplementations must be instantiated using \"instantiateSubImplementation(String packageName, String className, Implementation owner, Class<T> desiredType)\"";
	...
	// TODO: statt eigener methoden für versch. sub-implementierungen "generellen" class-loader einführen!? (sonst muss framework angepasst werden um weitere classen laden zu können....)
